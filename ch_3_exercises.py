#chapter 3 exercise coded by jim weisman
...
# 1 sample answer
print("comapared to the sample number of 3")
...
#input number
number: int = int(input("Please enter a number between 1 throught 5: "))
...
if number < 1 or number > 5:
    ...
    if number == 1:
            print ("I is the Roman numeral of 1.")
    elif number == 2:
            print ("II is the Roman numeral of 2.")
    elif number == 3:
            print ("III is the Roman numeral of 3.")
    elif number == 3:
            print ("III is the Roman numeral of 3.")
    elif number == 4:
            print  ("IV is the Roman numeral of 4.")
    elif number == 5:
            print  ("V is the Roman numeral of 5.")
...
# citizen (62 or over) , the charge is $9.89.
# If the person is age 12-
...
elif customer_age >= 4  <= 11:
            cost = .99
            #print ("You pay  .99 cents")

elif customer_age <= 3:
            #print ("Your child eats free")
            cost = 0
...
#just could not get this one to work the way I think it should,


tired = True
hungry = False
baby = str(input("Is the baby tired or hungry? "))
if tired:
    print("Eyes closed.")
else:
    print("Eyes open")
...
if tired:
    print("Eyes closed and quit")

else:
    print("Eyes open and crying")
    ...
    if hungry:
      ...
      status = eyes open
        ...
        if hungry:
                status = stauus + "and crying"
                                  print (status)


if true:
    print ("eyes closed and quite")
else:
    print("Eyes open and crying")
"""
