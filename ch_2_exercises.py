...
print("My name is Jim Weisman")
print ("My major is Web Design and Development")
...
# The dog says "woof!"
sam = '"the dog says "Woof"'
# or: sam = "the dog says \"Woof\"'
print (sam)
...
print ("do I really have to tell you")
age = 61
print(age)
print ("age " + str(age))
age = 42
