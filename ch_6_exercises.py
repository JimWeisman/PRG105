...
state_capitals.write("Alabana,Montgomery\n")
...
for x in range(0,books,1):
    ...
    books_file.write(output)
    print(output) #prints out all lines
    
# 3) Close the file
books_file.close

# print(output) #prints out last line only
"""
