...
work_days = days[1:3]
#work_days = days[1:3] + days [4:6]
#work_days = days[3] + days[5]+ days[6]
print (work_days)
...
calendar = [["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept"],[31,28,31,30,31,30,31,31,30,31,30,31]]
...
# 3) Print just the values for index
...
calenTuple = ("Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept")
print(calenTuple)
